...
from scraping import parse_user_collection, get_images
...
def get_parser():
    ...
    parser.add_argument("stars", nargs="+", help="stars to pick covers from")
    parser.add_argument(
        "filename",
...
if __name__ == "__main__":
    ...
    albums_info = parse_user_collection(username, stars)
    pics = ensure_download(albums_info, n_rows * n_cols)
    if pics:
        make_collage(pics, output_filename, n_rows, n_cols)
    else:
